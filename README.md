...
Im not a web developer, Im only a system administrator that knowns Python and some JS, and I strugle a lot with CSS, any suggestion/help to improve the frontend is welcome.
